 ...
 * @property {Array.<module:LeagueWrapper/dto/featuredGames~Mastery>} masteries - The masteries used by this participant
 * @property {number} profileIconId - The ID of the profile icon used by this participant
 * @property {Array.<module:LeagueWrapper/dto/featuredGames~Rune>} runes - The runes used by this participant
