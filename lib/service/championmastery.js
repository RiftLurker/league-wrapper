...
class ChampionmasteryService extends Service {
   ...
   * @param {?Error} error
   * @param {ChampionmasteryService~ChampionMasteryDTO} [data]
   */
  /**
   * @todo example
   ...
   *
   * @return {Promise.<ChampionmasteryService~ChampionMasteryDTO>}
   */
   ...
   * @param {?Error} error
   * @param {Array.<ChampionmasteryService~ChampionMasteryDTO>} [data]
   */
  /**
   * @todo example
   * @param {number} playerId
   ...
   *
   * @return {Promise.<Array.<ChampionmasteryService~ChampionMasteryDTO>>}
   */
