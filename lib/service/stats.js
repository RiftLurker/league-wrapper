...
const PlayerStatsSummaryListDto = require('../dto/stats/player-stats-summary-list-dto.js');
const RankedStatsDto = require('../dto/stats/ranked-stats-dto.js');
...
class StatsService extends Service {
  ...
  getSummaryBySummonerId(summonerId, query, options, callback) {
    options = Object.assign({
      ...
      query: query,
      returnType: PlayerStatsSummaryListDto
    }, options);
