...
class SummonerService extends Service {
   ...
   * @param {?Error} error
   * @param {Object.<SummonerService~SummonerDto>} [data]
   */
  /**
   * @todo example
   ...
   *
   * @return {Promise.<Object.<SummonerService~SummonerDto>>}
   */
   ...
   * @param {?Error} error
   * @param {Object.<SummonerService~MasteryPagesDto>} [data]
   */
  /**
   * @todo example
   * @param {number[]} summonerIds
   ...
   *
   * @return {Promise.<Object.<SummonerService~MasteryPagesDto>>}
   */
   ...
   * @param {?Error} error
   * @param {Object.<SummonerService~RunePagesDto>} [data]
   */
  /**
   * @todo example
   * @param {number[]} summonerIds
   ...
   *
   * @return {Promise.<Object<SummonerService~RunePagesDto>>}
   */
