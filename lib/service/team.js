...
class TeamService extends Service {
   ...
   * @param {?Error} error
   * @param {Object.<Array.<TeamService~TeamDto>>} [data]
   */
  /**
   * @todo example
   ...
   *
   * @return {Promise.<Object.<Array.<TeamService~TeamDto>>>}
   */
   ...
   * @param {?Error} error
   * @param {Object.<TeamService~TeamDto>} [data]
   */
  /**
   * @todo example
   ...
   *
   * @return {Promise.<Object.<TeamService~TeamDto>>}
   */
